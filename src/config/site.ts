...
const SITE_URL = import.meta.env.PUBLIC_SITE_URL || "https://codersjj.cn/";

export const siteConfig = {
  title: "Shane | Frontend & Fullstack Developer",
  author: "Shane",
  url: SITE_URL,
  mail: "codersjj@gmail.com",
  ...
  meta: {
    title: "Shane | Frontend & Fullstack Developer",
    description:
      "I'm Shane, a Frontend & Fullstack Web Developer focused on the React/Next.js ecosystem. I specialize in building scalable, SEO-optimized web applications with 5+ years of professional experience.",
    keywords:
      "Shane, codersjj, Web Developer, Frontend, Fullstack, React, Next.js, TypeScript, Node.js, Portfolio",
    image: `${SITE_URL}/og.jpg`,
    twitterHandle: "codersjj",
  },
  // social links
  social: {
    twitter: "https://x.com/codersjj",
    twitterName: "codersjj",
    github: "https://github.com/codersjj",
    blog: "https://codersjj.cn",
    xiaohongshu:
      "https://www.xiaohongshu.com/user/profile/5f2b6903000000000101f51f",
  },
};
